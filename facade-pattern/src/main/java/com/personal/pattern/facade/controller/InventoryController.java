...
@Tag(name = "Inventory", description = "Practice Inventory Controller")
public class InventoryController {
    ...
    @PostMapping(value = "/product/{productId}/update", consumes = "application/json", produces = "application/json")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public ResponseEntity<Object> addInventory(@PathVariable Integer productId, Integer quantity) {
